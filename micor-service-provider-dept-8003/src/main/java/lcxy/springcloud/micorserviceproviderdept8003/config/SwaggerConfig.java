package lcxy.springcloud.micorserviceproviderdept8003.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("lcxy.springcloud.micorserviceproviderdept8003.controller"))

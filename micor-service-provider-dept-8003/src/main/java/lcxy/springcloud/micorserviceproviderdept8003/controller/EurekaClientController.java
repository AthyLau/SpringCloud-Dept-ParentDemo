package lcxy.springcloud.micorserviceproviderdept8003.controller;
...
public class EurekaClientController {
    ...
    public Result getInfo(){
        return ResultGenerator.genSuccessResult("这是8003部门模块的服务");
    }
    ...
    public Result dsicovery(){
        ...
        List<ServiceInstance> serviceInstances = discoveryClient.getInstances("DEPT-PROVIDER");
